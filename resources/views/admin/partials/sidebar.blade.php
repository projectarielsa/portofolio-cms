    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
        ...
        @php
            ...
            $icons = [
                ...
                'academic' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 14.25a7.5 7.5 0 0 0-5.25 2.143M12 14.25a7.5 7.5 0 0 1 5.25 2.143M12 14.25V3.75m0 10.5a7.5 7.5 0 0 0-5.25-2.143M12 3.75a7.5 7.5 0 0 1 5.25 2.143M6.75 16.393V20.25A2.25 2.25 0 0 0 9 22.5h6a2.25 2.25 0 0 0 2.25-2.25v-3.857"/>',
                'document' => '<path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A3.375 3.375 0 0 0 11.25 11.625v6.75a3.375 3.375 0 0 0 3.375 3.375h1.5A3.375 3.375 0 0 0 19.5 18.375V14.25ZM4.5 6.75h7.125A2.625 2.625 0 0 1 14.25 9.375v9.375A2.625 2.625 0 0 1 11.625 21.375H7.125A2.625 2.625 0 0 1 4.5 18.75V6.75Z"/>',
