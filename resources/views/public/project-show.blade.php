...
@section('seo_description', Str::limit($project->description ?? 'Project oleh ' . ($about->name ?? 'Muhamad Ariel
    Saputra') . ' — IT Support & Laravel Developer.', 155))
@section('seo_keywords', $project->title . ', ' . ($project->tech_stack ?? 'Laravel, PHP') . ', portfolio project ' .
...
@section('content')
    ...
    <style>
        ...
        .ps-gallery-thumb:hover .ps-gallery-overlay {
            background: rgba(79, 70, 229, 0.18);
        }

        .ps-gallery-thumb .ps-gallery-overlay svg {
            opacity: 0;
            transform: scale(0.8);
            transition: all .25s ease;
        }

        .ps-gallery-thumb:hover .ps-gallery-overlay svg {
            opacity: 1;
            transform: scale(1);
        }
    ...
    <div class="ps-section">
        ...
        <div class="ps-hero">
            ...
            <div>
                <p
                    style="font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:0.1em; color:#6366f1; margin:0 0 14px;">
                    {{ $project->category ?: 'Project' }}
                </p>
                <h1
                    style="font-size:clamp(28px,4.5vw,46px); font-weight:800; color:#0f172a; line-height:1.2; letter-spacing:-0.02em; margin:0 0 20px;">
                    {{ $project->title }}
                </h1>
                    ...
                    <p class="ps-info-val">
                        @if ($project->status === 'published')
                            <span style="display:inline-flex;align-items:center;gap:6px;">
                                <span
                                    style="width:7px;height:7px;background:#34d399;border-radius:50%;display:inline-block;"></span>
                                Published
                            </span>
                        @else
                            Draft
        ...
        <div class="ps-cover">
            ...
            @else
                <div class="ps-cover-placeholder">
                    <div>
                        <p
                            style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.1em;color:#a5b4fc;margin:0 0 10px;">
                            Case Study</p>
                        <p
                            style="font-size:clamp(20px,3vw,32px);font-weight:800;color:#1e293b;margin:0;line-height:1.3;max-width:500px;">
        ...
        <div class="ps-content-grid">
            ...
            <aside class="ps-why">
                <p
                    style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.09em;color:#94a3b8;margin:0 0 14px;">
                    Why it matters</p>
                ...
                <p style="font-size:14px;color:#64748b;line-height:1.7;margin:0;">
                    Halaman detail project membantu menjelaskan konteks, fitur, stack, dan keputusan implementasi sehingga
                    karya Anda lebih mudah dinilai oleh recruiter atau hiring manager.
                </p>
            </aside>
        </div>
    ...
    @if ($relatedProjects->count() > 0)
        <div class="ps-related">
            <div style="display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin-bottom:28px;">
                <div>
                    <p
                        style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.09em;color:#94a3b8;margin:0 0 8px;">
                        Related Projects</p>
            ...
            <div class="ps-related-grid">
                @foreach ($relatedProjects as $related)
                    <a href="{{ route('projects.show', $related) }}" class="ps-related-card">
                        <p
                            style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.09em;color:#94a3b8;margin:0 0 10px;">
