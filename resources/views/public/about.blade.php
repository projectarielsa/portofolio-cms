...
@section('seo_description', 'Tentang ' . ($about->name ?? 'Muhamad Ariel Saputra') . ' — IT Support & Laravel Developer. Lulusan S1 Teknik Informatika, berpengalaman di troubleshooting, jaringan LAN/WAN, Linux server, dan Laravel.')
@section('seo_keywords', ($about->name ?? 'Muhamad Ariel Saputra') . ', profil IT support, tentang Ariel Saputra, Teknik Informatika')
            ...
            <div class="mb-8 flex flex-col gap-6 sm:flex-row sm:items-center">
                ...
                @if ($photoUrl)
                    ...
                    >
                        ...
                        {{-- ZOOM ICON --}}
                        <div class="absolute inset-0 flex items-center justify-center rounded-2xl bg-slate-900/0 opacity-0 transition duration-300 group-hover:bg-slate-900/40 group-hover:opacity-100">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    @forelse ($skills->take(12) as $skill)
                        ...
                        <span class="rounded-full border border-indigo-100 bg-indigo-50 px-3 py-1.5 text-xs font-semibold text-indigo-600">
                            {{ $skill->name }}
                        </span>
