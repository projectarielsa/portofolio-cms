        ...
        <div class="animate-fadeup">
            ...
            @if($about && $about->open_to_work)
                <div class="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 mb-8">
                    ...
                    <span class="text-xs font-semibold text-emerald-700 tracking-wide">
                        Aktif Mencari Kerja · Open to Work
                    </span>
                </div>
            @endif
                    ...
                    <div class="rounded-[2rem] bg-gradient-to-br from-slate-50 via-white to-indigo-50/40 border border-slate-100 p-7">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="h-10 w-10 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center shadow-md shadow-indigo-200">
                                    ...
                                    <span class="text-sm font-bold text-white">
                                        {{ strtoupper(substr($about->name ?? 'A', 0, 1)) }}
                                    </span>
                            ...
                            <div class="flex items-center gap-1.5 rounded-full {{ ($about->open_to_work ?? true) ? 'bg-emerald-50 border border-emerald-200' : 'bg-slate-100 border border-slate-200' }} px-3 py-1.5">
                                ...
                                <span class="text-[11px] font-semibold {{ ($about->open_to_work ?? true) ? 'text-emerald-700' : 'text-slate-500' }}">
                        ...
                        <div class="space-y-3.5">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-sm font-semibold {{ ($about->open_to_work ?? true) ? 'text-emerald-600' : 'text-slate-500' }}">
                                    {{ ($about->open_to_work ?? true) ? 'Open to Work' : 'Closed to Work' }}
                                </span>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            @foreach(['IT Support', 'Laravel', 'Linux', 'Networking', 'MySQL', 'PHP'] as $tag)
                                ...
                                <span class="rounded-full border border-indigo-100 bg-indigo-50 px-3 py-1.5 text-[11px] font-semibold text-indigo-600 tracking-wide">
                                    {{ $tag }}
                                </span>
                        ...
                        <div class="mt-6 flex items-center justify-between rounded-2xl bg-slate-50 border border-slate-100 px-5 py-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-slate-800 mt-0.5">
                                    Full-time · IT Support / Web Dev
                                </p>

                            </div>

                            <a href="{{ route('contact') }}"
                               class="rounded-xl btn-primary px-4 py-2 text-xs font-bold shadow-md shadow-indigo-200">
...
<section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between mb-12">
        ...
        <div>
            ...
            <p class="text-xs font-bold uppercase tracking-widest text-indigo-500 mb-3">
                Selected Work
            </p>
            ...
            <p class="mt-3 text-slate-500 max-w-xl">
                Kumpulan project yang mencerminkan cara saya membangun dan menyelesaikan masalah teknis.
            </p>
    ...
    @if($projectCount === 5)
        ...
        <div class="space-y-6">
                        ...
                        <div class="aspect-[16/10] overflow-hidden bg-slate-100 shrink-0">
                            ...
                            @else
                                ...
                                <div class="flex h-full w-full flex-col justify-end p-6 bg-gradient-to-br from-indigo-50 via-white to-violet-50">
                                    ...
                                    <p class="text-[10px] uppercase tracking-widest text-indigo-400 mb-2 font-semibold">
                                        {{ $project->category ?: 'Project' }}
                                    </p>

                                    <p class="font-display text-xl font-bold text-slate-800">
                                        {{ $project->title }}
                                    </p>
                        ...
                        <div class="flex flex-col flex-1 p-6">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-3">
                                ...
                                @if ($project->is_featured)
                                    ...
                                    <span class="rounded-full bg-indigo-50 border border-indigo-200 px-2.5 py-1 text-[10px] font-bold text-indigo-600 uppercase tracking-wide">
                                        Featured
                                    </span>
            ...
            <div class="grid gap-6 md:grid-cols-2 max-w-5xl mx-auto">
                ...
                @foreach($featuredProjects->slice(3, 2) as $project)
    ...
    @else
        ...
        {{-- =====================================================
             1, 2, 3, 4 ATAU LEBIH DARI 5 PROJECT
        ====================================================== --}}

        @php

            $gridClass = match ($projectCount) {
                ...
                4 => 'grid-cols-1 md:grid-cols-2 max-w-5xl mx-auto',
    ...
    <div class="rounded-3xl bg-white border border-slate-200 shadow-sm p-10 lg:p-14">
        ...
        <div class="grid gap-16 lg:grid-cols-[1fr_1.2fr] lg:items-start">
            ...
            <div class="lg:sticky lg:top-28">
                ...
                <p class="text-xs font-bold uppercase tracking-widest text-violet-500 mb-3">
                    What I Do
                </p>
                ...
                @forelse ($services as $index => $service)
                    ...
                    <div class="card-hover group rounded-2xl border {{ $sc['border'] }} {{ $sc['bg'] }} p-6">
                        ...
                        <div class="mb-5 flex h-10 w-10 items-center justify-center rounded-xl bg-white border {{ $sc['border'] }} shadow-sm">
                            ...
                            <span class="text-sm font-bold {{ $sc['text'] }}">
                                {{ strtoupper(substr($service->title, 0, 2)) }}
                            </span>

                        </div>

                        <h3 class="font-display text-base font-bold text-slate-800 mb-3">
                            {{ $service->title }}
                        </h3>

                        <p class="text-sm leading-7 text-slate-500 text-justify">
                            {{ $service->description }}
                        </p>
...
<section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 pb-20">
    ...
    <div class="grid gap-16 lg:grid-cols-[1fr_1.5fr] lg:items-center">
        ...
        <div>
            ...
            <p class="text-xs font-bold uppercase tracking-widest text-emerald-500 mb-3">
                Tech Stack
            </p>
